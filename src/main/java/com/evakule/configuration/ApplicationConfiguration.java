package com.evakule.configuration;
...
@EnableWebMvc
@Configuration
@ComponentScan("com.evakule")
@EnableTransactionManagement
@EnableJpaRepositories("com.evakule.dao")
...
public class ApplicationConfiguration implements WebApplicationInitializer, WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.evakule.model");
